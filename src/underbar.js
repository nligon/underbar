(function() {
  ...
  // last element. If n is greater than the array length, return the entire array.
  ...
  //     if (accumulator === undefined && idxOrKey === 0) {
  ...
  // GOOD SHORT
  // _.reduce = function(set, iterator, memo) {
  //   _.each(set, function(item, idx) {
  //     memo === undefined && !idx ? memo = set[0] : memo = iterator(memo, item);
  //   });
  //   return memo;
  // };
  ...
  //   var memoUndef = arguments.length < 3;
  //   _.each(collection, function(value, idxOrKey) {
  //     if (memoUndef) {
  //       memo = value;
  //       memoUndef = false;
  //     } else {
  //       memo = callback(memo, value, idxOrKey);
  //     }
  //   });
  //   return memo;
  // };
